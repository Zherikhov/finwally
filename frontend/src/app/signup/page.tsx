    ...
    <div className="relative flex min-h-screen flex-col items-center bg-white px-6 pt-12 pb-12 lg:px-8">
      ...
      <div className="relative z-20 w-full max-w-sm">
        <div className="flex flex-col items-center mb-8">
          ...
          <h2 className="text-3xl font-bold tracking-tight text-slate-900 text-center relative z-30">
            Sign Up for FinWally
          </h2>
          <p className="mt-2 text-sm text-slate-900 font-medium text-center relative z-30 drop-shadow-sm whitespace-nowrap">
            Join FinWally and manage your personal finances with ease.
          </p>
        </div>
        ...
        <div className="bg-white/80 backdrop-blur-sm p-8 rounded-2xl shadow-xl border border-slate-100">
          ...
          <div className="mt-8">
            ...
            <div className="mt-6 grid grid-cols-2 gap-4">
              <button className="flex items-center justify-center px-4 py-2 border border-slate-100 rounded-lg shadow-sm bg-white hover:bg-slate-50 transition duration-150">
              ...
              <button className="flex items-center justify-center px-4 py-2 border border-slate-100 rounded-lg shadow-sm bg-white hover:bg-slate-50 transition duration-150">
                <svg className="h-5 w-5 mr-2" fill="currentColor" viewBox="0 0 24 24">
                  <path d="M17.073 11.204a4.568 4.568 0 0 0 2.174-3.834 4.722 4.722 0 0 0-4.634-4.73c-1.12 0-2.316.544-3.23 1.14-.946-.607-2.138-1.157-3.32-1.157-2.553 0-4.634 2.115-4.634 4.73 0 1.574.83 2.97 2.17 3.826-.957.65-1.572 1.705-1.572 2.91 0 2.502 2.052 4.532 4.582 4.532.964 0 1.868-.3 2.624-.814.757.514 1.66.814 2.624.814 2.53 0 4.582-2.03 4.582-4.532 0-1.21-.62-2.268-1.583-2.925z" />
                </svg>
                <span className="text-sm font-medium text-slate-700">Apple</span>
              </button>
              <button className="flex items-center justify-center px-4 py-2 border border-slate-100 rounded-lg shadow-sm bg-white hover:bg-slate-50 transition duration-150 col-span-2">
