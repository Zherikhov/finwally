    ...
    <div className="relative flex min-h-screen flex-col items-center bg-white px-6 pt-12 pb-12 lg:px-8">
      ...
      <div className="relative z-20 w-full max-w-sm">
        <div className="flex flex-col items-center mb-8">
          ...
          <h2 className="text-3xl font-bold tracking-tight text-slate-900 relative z-30">
            Log In to FinWally
          </h2>
          <p className="mt-2 text-sm text-slate-900 font-medium relative z-30 drop-shadow-sm">
          ...
          <div className="mt-8">
            <div className="relative">
              ...
              <div className="relative flex justify-center text-sm">
                <span className="bg-white px-2 text-slate-400">Or log in with</span>
              </div>
            </div>
